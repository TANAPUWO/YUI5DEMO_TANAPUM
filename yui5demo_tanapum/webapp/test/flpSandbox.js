		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Timeline",
									"targetURL": "#yui5demotanapum-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yui5demotanapum-display": {
								"semanticObject": "yui5demotanapum",
								"action": "display",
								"description": "Show my Timeline",
								"title": "My Timeline",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yui5demotanapum",
									"url": sap.ui.require.toUrl("yui5demotanapum")
								}
							}
						}
					}
